...
function getLocation(){
	...
	navigator.geolocation.getCurrentPosition(function(position){
		...
		$.ajax({
			url: 'https://maps.googleapis.com/maps/api/geocode/json?language=en&latlng='+lat+','+lon,
			//url: 'http://newsky2.kma.go.kr/service/SecndSrtpdFrcstInfoService2/ForecastGrib?ServiceKey=PhNxHRpHskGel3JlrJMnhPIK3coH03Yfy6hYaNmocOUInZ3YTOaMnObqdKBDRS1k%2F6%2Fmxs79t%2BcRX7VnUSEQuQ%3D%3D&base_date=20170323&base_time=1800&nx=73&ny=134&pageNo=1&numOfRows=6&_type=json'
			datatype: 'jsonp',
