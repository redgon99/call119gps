...
<script src="js/geo_app_cn.js"></script>
<script> //----구글 어날리틱스 코드
...
<script type="text/javascript">
	function sendata() {
		...
		if(accu > 100) {
			if(confirm("如果报警 这将视为您同意将您的个人信息提供给我们 ，确定要报警吗?")){
...
<body>
<div id="title" align="center"><h2>江原119接警</h2></div>
<div id="addr">地址</div>
<div id="latitude" class="float_style">纬度</div>
<div id="space" class="float_style">&nbsp;/&nbsp;</div>
<div id="longitude">经度</div>
<div id="altitude" class="float_style">高度</div>
<div id="space" class="float_style">&nbsp;/&nbsp;</div>
<strong><mark><div id="accuracy">位置误差</div></mark></strong>
<div id="message01">信息</div>
<div id="message02">信息</div>
<div id="send" onClick="sendata();"><h1>报警119</h1></div>
